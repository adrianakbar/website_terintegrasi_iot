...
<body>
    ...
    <div class="container-fluid content">
        <div class="row">
            ...
            <div class="col-md-7 formgantiprofil">
                @if (session('success'))
                ...
                <div>
                    <form action="" method="POST">
                        @csrf
                        <div class="row mb-3">
                            <label for="inputNama3" class="col-sm-4 col-form-label"><i class="fa-solid fa-user"></i> Masukkan Nama Baru</label>
                            <div class="col-sm-6">
                        ...
                        <div class="row mb-3">
                            <label for="inputEmail3" class="col-sm-4 col-form-label"><i class="fa-solid fa-envelope"></i> Masukkan Email Baru</label>
                            <div class="col-sm-6">
                        ...
                        <div class="row mb-3">
                            <label for="inputNomorhp3" class="col-sm-4 col-form-label"><i class="fa-solid fa-phone"></i> Masukkan Nomor Baru</label>
                            <div class="col-sm-6">
